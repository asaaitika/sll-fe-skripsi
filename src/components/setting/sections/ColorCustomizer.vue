		...
		>
			<div class="form-group d-flex justify-content-between align-items-center">
				...
				<input
					...
					:value="themeColor.colors['--{{prefix}}primary']"
				/>
			</div>
			<div class="form-group d-flex d-flex justify-content-between align-items-center">
				...
				<input
					...
					:value="themeColor.colors['--{{prefix}}info']"
				/>
			</div>
		</div>
		<div class="grid-cols-5 mb-4 d-grid gap-3">
			<radio-input
				v-for="(data, index) in defaultColors"
				:key="index"
				btn-name="theme_color"
				:id="data.value"
				label-class="bg-transparent d-block"
				:default-checked="themeColor.value"
				:value="data.value"
			...
			>
				...
				>
					<circle
						...
						cy="12"
						r="10"
						:fill="data.colors['--{{prefix}}primary']"
					/>
					<path
						d="M2,12 a1,1 1 1,0 20,0"
						:fill="data.colors['--{{prefix}}info']"
					/>
				</svg>
			</radio-input>
		</div>
