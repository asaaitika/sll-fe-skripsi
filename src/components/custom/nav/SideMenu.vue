<template>
	<li
		:class="navItemClass"
		v-if="isTag !== 'router-link'"
	>
		<a
			ref="elem"
			:class="navLinkClass"
			aria-current="page"
			:href="createRoute(route.to)"
			:to="route"
	...
	>
		<li :class="navItemClass + ' ' + (isExactActive ? 'active' : '')">
			<a
				ref="elem"
				:class="navLinkClass + ' ' + ' ' + (isExactActive ? 'active' : '')"
				aria-current="page"
				@click="doLogout(route.to)"
			>
				<i
					:class="iconClass"
					v-if="iconClass"
