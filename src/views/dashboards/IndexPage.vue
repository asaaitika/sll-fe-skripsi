	...
	<div class="row">
					...
					<div class="card aos-init aos-animate">
						...
						<div class="card-body">
							<apexchart
								...
								type="area"
								id="d-main"
								:options="grossSaleChart.options"
								:series="grossSaleChart.series"
							/>
						</div>
					</div>
				</div>
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<div
													class="shadow-none progress bg-soft-primary w-100"
													style="height: 4px"
												>
													<div
										...
										<tr>
											...
											<td>
												...
												<div
													class="shadow-none progress bg-soft-success w-100"
													style="height: 4px"
												>
													<div
		...
		<div class="col-md-12 col-lg-4">
			<div class="row">
				...
				<div class="col-md-12 col-lg-12">
					<div
						class="card aos-init aos-animate"
						data-aos="fade-up"
						data-aos-delay="600"
					>
						<div class="flex-wrap card-header d-flex justify-content-between">
